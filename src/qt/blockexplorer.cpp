...
{
    std::string genesisblockhash = "00000f1604059fd56c401f2f33524b2ad751674ce40eef3430a4ecb8c26c2c4f";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (GoldCash.conf).");
            QMessageBox::warning(this, "Gold Cash Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
