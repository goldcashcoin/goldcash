...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Gold Cash Core"),
     ...
     * override -datadir in the GoldCash.conf file in the default data directory
     * (to be consistent with GoldCashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
