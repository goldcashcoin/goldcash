                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Gold Cash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Gold Cash address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Gold Cash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gold Cash Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gold Cash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gold Cash addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Gold Cash Core help message to get a list with possible 1776 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Gold Cash Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Gold Cash Core"); // default title
