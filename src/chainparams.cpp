...
( 0, uint256("0000058cee8030a2ff76e78a7a8d4950ac9386db6362877f5f58a67aee64312a"));

static const Checkpoints::CCheckpointData data = {
&mapCheckpoints,
1512690404, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // 1776: 2 minute
        nTargetSpacing = 1 * 60;  // 1776: 2 minute
        nLastPOWBlock = 3000;
        nMaturity = 5;
        nMasternodeCountDrift = 20;
        nModifierUpdateBlock = 0;
        nMaxMoneyOut = int64_t(16000000000) * COIN;
        ...
        nRequiredMasternodeCollateral = 1000 * COIN; //1,000

        const char* pszTimestamp = "Gold Cash 2017";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 3200000000 * COIN;
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1516585177;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 9972220;

        hashGenesisBlock = uint256("0000058cee8030a2ff76e78a7a8d4950ac9386db6362877f5f58a67aee64312a");
        ...
        assert(hashGenesisBlock == uint256("0000058cee8030a2ff76e78a7a8d4950ac9386db6362877f5f58a67aee64312a"));
        assert(genesis.hashMerkleRoot == uint256("38f8d20434aeea170e58dd278b389d373e579f2869fc525f157009fc1d622f14"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("52.14.239.188", "52.14.239.188")); 
        //vSeeds.push_back(CDNSSeedData("104.131.30.157", "104.131.30.157")); 
        //vSeeds.push_back(CDNSSeedData("67.199.118.93", "67.199.118.93")); 

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 0x25);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 0x76);
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 0xff);
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(25)(76)(58)(103).convert_to_container<std::vector<unsigned char> >();
        ...
        nStartMasternodePayments = 1516585177; //Wed, 25 Jun 2014 20:36:16 GMT
    }
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("c746154750c13a414f43607752dcb0d9fd7faff161269f10263e2741a5f7be35"));
