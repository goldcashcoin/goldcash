...
pkgdatadir = $(datadir)/goldcash
pkgincludedir = $(includedir)/goldcash
pkglibdir = $(libdir)/goldcash
pkglibexecdir = $(libexecdir)/goldcash
...
ACLOCAL = ${SHELL} /home/patrick/dash/GoldCash-Linux/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/patrick/dash/GoldCash-Linux/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/patrick/dash/GoldCash-Linux/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/patrick/dash/GoldCash-Linux/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/patrick/dash/GoldCash-Linux/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = goldcash
PACKAGE_BUGREPORT = www.goldcash.io
PACKAGE_NAME = Gold Cash Core
PACKAGE_STRING = Gold Cash Core 1.0.1
PACKAGE_TARNAME = goldcash
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/patrick/dash/GoldCash-Linux
abs_srcdir = /home/patrick/dash/GoldCash-Linux
abs_top_builddir = /home/patrick/dash/GoldCash-Linux
abs_top_srcdir = /home/patrick/dash/GoldCash-Linux
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/patrick/dash/GoldCash-Linux/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/sssd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/sss-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/sss-cli$(EXEEXT)
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_sss_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_sss_coverage.info test_sss.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/SSS-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/SSS-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/SSS-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/SSS-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_sss.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_sss -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_sss_filtered.info: test_sss.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_sss_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_sss_coverage.info: baseline_filtered_combined.info test_sss_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_sss_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_sss_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_sss_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_sss.coverage/.dirstamp:  test_sss_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_sss.coverage/.dirstamp total.coverage/.dirstamp

# SSS: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_sss.coverage/ total.coverage/ $(OSX_APP)
